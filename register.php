	...
	if($count==0){
		...
		if($MySQLi_CON->query($query))
		{
			echo '<script type="text/javascript">
             alert("Register Data Sukses!\n=========================\nSeilahka lakukan pembaran \nDan segera konfirmasi ke alamat berikut\nEmail : cs@localhost.com\n      : admin@locahost.com\nNama : ' . $uname . '\nDurasi : ' . $numdays . ' Hari\nBerakhir : ' . $exp . '\n=========================\nNB : Simpan Sebagai Bukti Transaksi!");</script>';
	...
	<div class="container">
       ...
       <form class="form-signin" method="post" id="register-form">
        ...
        <input type="password" class="form-control" placeholder="Password" name="password" required  />
         ...
         <div class="form-group">
        <select  class="form-control" name="numdays" required  />
        <option value='3'>3 Hari</option>
		<option value='7'>7 Hari</option>
		<option value='14'>14 Hari</option>
		<option value='30'>30 Hari</option></select>
        </div>
